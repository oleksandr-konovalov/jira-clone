...
const filterProjects = (projects: ProjectSearchData[], query: string): ProjectSearchData[] => {
  ...
  return projects.filter(
    (p) =>
      ...
      p.issues.some(
        (issue) => issue.id.toLowerCase().includes(q) || issue.name.toLowerCase().includes(q)
      )
  );
};
  ...
  return (
    <div className="p-6">
      ...
      {filteredProjects.length === 0 ? (
        <div className="mt-8 text-center text-font-subtle">
